...
中学校 技術・家庭科(技術分野)向け自作Web教材のリンク集(先生向け紹介ページ)。

**公開ページ: https://choppermoon1623-tech.github.io/gijutsu-kyouzai/**
...
| A 材料と加工 | 🪟 組子パターンメーカー | [kumiko-svg](https://github.com/choppermoon1623-tech/kumiko-svg) |
...
| D 情報 | 🔍 計測・制御 逆引きシステム | [keisoku-gyakubiki](https://github.com/choppermoon1623-tech/keisoku-gyakubiki) |
| D 情報 | 💾 テスト対策 情報の技術 | [techart-3](https://github.com/choppermoon1623-tech/techart-3) |
| 教科をこえて | 🔔 早押しクイズスタジオ | [hayaoshi-quiz](https://github.com/choppermoon1623-tech/hayaoshi-quiz) |

## 教材の追加・編集

`index.html` 内のカード(`<div class="card">`)をコピーして書きかえるだけです。
領域セクション(`<section class="area-a">` など)の中に追加してください。
